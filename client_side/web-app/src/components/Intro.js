...
// importing plots that cover all sources combined
...
// intro component will be entired intro page made up of mixture of other components and html elements
function Intro() {
  // resize detector with limit of once per second refresh, for adjusting some elements on window resize
  ...
  const handleTitles = useCallback(() => {
    ...
    // using regex to split into certain number of words then rejoin with line break
    if ( width <= 600 ) {
